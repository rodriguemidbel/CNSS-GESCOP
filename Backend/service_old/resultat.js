...
class resultatService {
  createResultat(ResultatDto) {
    const { dossier_id,date_par_res,num_par_res,attributaire,fichierpub,fichier } = ResultatDto;
    return resultatDAO.createResultat(dossier_id,date_par_res,num_par_res,attributaire,fichierpub,fichier);
  };
